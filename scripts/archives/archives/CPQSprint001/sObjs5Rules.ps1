...
$wherePriceRule = "('EX-20230320.30','EX-20230302.0','EX-20230328.01','EX-20230328.02','EX-20230320.1','EX-20230327.01',"+
...
$packageHash.add("SBQQ__PriceCondition__c",
   ...
   "; 
        ...
        importOrder = "4";
        where       = " where SBQQ__Rule__r.External_id__c in "+$wherePriceRule ;
      #  ignore = $true
