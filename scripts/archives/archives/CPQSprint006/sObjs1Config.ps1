...
$packageHash.add("SBQQ__CustomAction__c.NoAction", 
    ...
    ";
        importOrder         = "1";
        where1               = " where  External_id__c in " + $wherex ;
...
$packageHash.add("SBQQ__CustomActionCondition__c", 
    ...
    where     = " where  SBQQ__CustomAction__r.External_id__c like " + $whereLike ;      
    ...
    , SBQQ__TargetField__c,
      SBQQ__TargetObject__c  ";
      where        = " where  SBQQ__Action__r.External_id__c like " + $whereLike ;      
...
$packageHash.add("SBQQ__SummaryVariable__c.parent", 
 ...
 ";
        importOrder = "1";
        where               = " where  External_id__c like " + $whereLike  ;        
        where1       = " where SBQQ__CombineWith__c = '' "
      # ignore      = $true
    } )
