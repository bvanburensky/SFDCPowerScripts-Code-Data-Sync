...
$onlyProcessSObject = ""
$onlyProcessDirectory = "Sprint-4"

## Inputoutput subdir contain your deployment
$csvOutOverride = 'Sprint-4' 
...
$csvOutputPath = "./scripts/data/org/" + $sourceOrgAlias + "/"
if($csvOutOverride -gt "") {
  $csvOutputPath = "./scripts/data/org/"+$csvOutOverride +"/" + $sourceOrgAlias + "/"
}
