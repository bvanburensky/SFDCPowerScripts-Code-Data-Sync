...
$packageHash.add("SBQQ__TemplateContent__c", 
    @{fields        = 
        ...
        SBQQ__Type__c,
        Name";
        #where  = "where Unique_ID__c in ('EX-00000001','EX-00000002','EX-00000003','EX-00000004','EX-00000005','EX-00000006','EX-00000007',"+
         ###                               "'EX-00000025','EX-00000026','EX-20221025.01','EX-20221025.02','EX-20221025.05','EX-20221025.20','EX-20221025.55',"+
          #                              "'EX-20221025.60','EX-20221025.70','EX-20221025.80','EX-20221025.90','EX-281022.01')" 
        where  = "where Unique_ID__c like 'EX%'  and Unique_ID__c != 'EX-00000009'"
        importOrder = "1"
        #ignore      = $true
    } )

# SBQQ__LogoDocumentId__c, do not migrate 
...
$packageHash.add("SBQQ__TemplateSection__c",
    ...
    SBQQ__TopMargin__c";
         where  = "where Unique_ID__c like 'EX%'  and Unique_ID__c != 'EX-00000006'  and  Unique_ID__c != 'EX-20221113.01' "
        <#
        "where Unique_ID__c in
                                 ('EX-20221024.07','EX-20221024.20','EX-20221024.25',"+
                                  "'EX-20221024.50','EX-00000004','EX-00000001','EX-00000002','EX-00000003','EX-00000005','EX-00000006','EX-00000007',"+
                                  "'EX-00000008','EX-00000009','EX-00000010','EX-00000011','EX-00000012','EX-00000013','EX-00000014','EX-00000015','EX-00000016',"+
                                  "'EX-00000017','EX-00000018','EX-20221024.01','EX-00000019','EX-00000020','EX-202210224.30','EX-20221024.02','EX-20221024.03',"+
                                  "'EX-20221024.05','EX-281022.01','EX-281022.02')" 
        #>
        importOrder = "3"
       # ignore      = $true
    } )
...
$packageHash.add("SBQQ__LineColumn__c", 
    ...
    where  = "where Unique_ID__c like 'EX%'   "
     #   where = "where Unique_ID__c in ('EX-00000001','EX-00000002','EX-00000003','EX-00000004','EX-00000005'," +
     ##             " 'EX-00000006','EX-00000007','EX-00000008','EX-00000009','EX-00000010','EX-00000011','EX-00000012','EX-00000013',"+
     #             "'EX-00000014','EX-00000015','EX-00000016','EX-00000017','EX-00000018','EX-00000019',"+
     #             "'EX-00000020','EX-00000021','EX-00000022','EX-00000023','EX-00000024')"
        importOrder = "4"
   #    ignore      = $true
    } )
...
$packageHash.add("SBQQ__QuoteTerm__c.NoParent", 
    ...
    where = "where Unique_ID__c like 'EX-QT%'"
#        where = "where Unique_ID__c in ('EX-QT-0001','EX-QT-0002','EX-QT-0003','EX-QT-0004','EX-QT-0005','EX-QT-0006',"+
##                                    "'EX-QT-0007','EX-QT-0008','EX-QT-0009','EX-QT-0010','EX-QT-0011','EX-QT-0012',"+
 #                                   "'EX-QT-0013','EX-QT-0014','EX-QT-0015')"
        importOrder = "1";
        ignore      = $false
...
$packageHash.add("SBQQ__QuoteTerm__c.Parent", 
    ...
    , SBQQ__Body__c 
    ";
        where  = "where Unique_ID__c in ('EX-QT-0001','EX-QT-0002','EX-QT-0003','EX-QT-0004','EX-QT-0005',"+
                                        "'EX-QT-0006','EX-QT-0007','EX-QT-0008','EX-QT-0009','EX-QT-0010',"+
                                        "'EX-QT-0011','EX-QT-0012','EX-QT-0013','EX-QT-0014','EX-QT-0015')"  
        importOrder   = "2"
        ignore      = $true
    } )
