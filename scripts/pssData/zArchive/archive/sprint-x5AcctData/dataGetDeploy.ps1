...
$onlyProcessFile = "sObjs6AcctContact.ps1"
$onlyProcessSObject = "Contact"
$onlyProcessDirectory = "sprint-x5AcctData"
#$onlyProcessDirectory = "sprint-5"

## Inputoutput subdir contain your deployment
$csvOutOverride = 'sprint-x5AcctData' 
