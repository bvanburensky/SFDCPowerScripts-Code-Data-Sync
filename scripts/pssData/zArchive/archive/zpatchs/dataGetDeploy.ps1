...
if ($ReplaceTextFrom -gt "" ) {
  $commandParm += "-ReplaceTextFrom $ReplaceTextFrom "
}

if ($ReplaceTextTo -gt "" ) {
  $commandParm += "-ReplaceTextTo $ReplaceTextTo "
}
