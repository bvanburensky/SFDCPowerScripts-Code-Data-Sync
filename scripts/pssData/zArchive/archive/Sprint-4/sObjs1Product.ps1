...
$packageHash.add("Product2.Updates", 
  @{
    ...
    suffix      = "x1" ;
    importOrder = "2";
    where       = " where Unique_ID__c in ('EX-20221113.01','EX-20221113.05','EX-00000231') ";
    fields        =
        " 
        Name,
        Unique_ID__c,
    ...
    $packageHash.add("PriceBookEntry.standard", 
    @{
      #ignore = $true ;
     # suffix      = "x1" ;
      importOrder = "4";

      where       = " where Product2.Unique_ID__c in ('EX-20221113.01','EX-20221113.05') and Pricebook2.IsStandard = true";
      fields        =
          "  
   ...
   $packageHash.add("PriceBookEntry.nonStandard", 
    @{
      #ignore = $true ;
     # suffix      = "x1" ;
      importOrder = "5";

      where       = " where Product2.Unique_ID__c in ('EX-20221113.01','EX-20221113.05') and Pricebook2.IsStandard = false";
      fields        =
          "  
