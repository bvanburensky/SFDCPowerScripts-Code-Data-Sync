...
$packageHash.add("SBQQ__TemplateSection__c",
    ...
    SBQQ__TopMargin__c";
        where  = "where Unique_ID__c in ('EX-00000010','EX-20221121.01', 'EX-20221208.01','EX-20221113.01')  " 
        importOrder = "3"
 #      ignore      = $true
    } )
...
$packageHash.add("SBQQ__LineColumn__c", 
    ...
    SBQQ__WidthDiscardedWhenHidden__c    ";
        where = "where SBQQ__Section__r.Unique_ID__c in ('ad.01','EX-20221208.01','EX-20221113.01')  " 
        importOrder = "4"
      # ignore      = $true
    } )
