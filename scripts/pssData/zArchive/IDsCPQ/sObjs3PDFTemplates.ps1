...
$packageHash.add("SBQQ__TemplateSection__c",
 ...
 ,Name
   ...
   ,SBQQ__ConditionalPrintField__c,SBQQ__Content__r.Unique_ID__c,SBQQ__DisplayOrder__c,
   SBQQ__FilterField__c,SBQQ__FilterOperator__c,SBQQ__FilterValue__c,SBQQ__GroupField__c,SBQQ__KeepTogether__c,
   SBQQ__KeepWithNext__c,SBQQ__KeepWithPrevious__c,SBQQ__PageBreak__c,SBQQ__QuoteTotalsPrinted__c,SBQQ__RollUpField__c,
   SBQQ__SummaryDisplay__c,SBQQ__TopMargin__c";
        importOrder = "3"
    } )
...
$packageHash.add("SBQQ__QuoteTerm__c.Parent", 
    ...
    , Section_Name__c 
    , Term_Desc__c  ";
        #where_ignored = " where Unique_ID__c = 'EX-021010004'"  
