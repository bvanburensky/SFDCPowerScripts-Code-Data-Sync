...
$TemplateContent = "('EX-000003','EX-000017','EX-000021','EX-000022') ";
...
$packageHash.add("SBQQ__TemplateContent__c", 
    @{fields        = 
        ...
        importOrder = "1"
        where       = " where External_id__c in "+$TemplateContent ;
        orderBy     = "order by External_id__c  ";  
  ignore      = $true
    } )


    $packageHash.add("SBQQ__TemplateSection__c.display",
    @{fields        = "
    External_id__c,
  ...
  ";
    ...
    $packageHash.add("SBQQ__TemplateSection__c.New",
    @{fields        = "
    External_id__c,
    Name,
    ...
    SBQQ__Content__r.External_id__c ,
...
$packageHash.add("SBQQ__LineColumn__c.new", 
    @{fields        = 
    "  External_id__c,
    Name,
    SBQQ__Template__r.External_id__c ,
...
$packageHash.add("SBQQ__QuoteTemplate__c", 
 ##SBQQ__LogoDocumentId__c,
    @{fields        = 
        ...
        SBQQ__FooterContent__r.External_id__c ,
        Name  ,
...
$packageHash.add("SBQQ__QuoteTerm__c.Parent", 
    ...
    , SBQQ__Active__c 
    , SBQQ__Locked__c 
    , SBQQ__ParentTerm__r.External_id__c
    , SBQQ__PrintOrder__c 
    , SBQQ__Quote__c 
    , SBQQ__StandardTerm__c 
    , SBQQ__Status__c 
