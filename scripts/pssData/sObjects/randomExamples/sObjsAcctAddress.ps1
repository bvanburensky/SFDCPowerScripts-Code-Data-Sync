...
$packageHash.add("TAG_Address__c.statss", 
@{fields        =
    " 
   id 
";
...
$packageHash.add("TAG_Address__c.patch", 
@{fields        =
    " 
   id 
";
  ...
  $packageHash.add("TAG_Address__c.AutoNumber", 
  @{fields        =
      " 
     id,Name
  ";
  ...
  # ,Renewal_Mode__c, Account_Seq_Number__c,Account_Name__c,ContractNumber
  $packageHash.add("TAG_Address__c.fixCountry", 
  @{fields        =
      " 
  ...
  # ,Renewal_Mode__c, Account_Seq_Number__c,Account_Name__c,ContractNumber
  $packageHash.add("TAG_Address__c.fixState", 
  @{fields        =
      " 
     id,State_Name__c  
  ";
...
$packageHash.add("TAG_Address__c.strr", 
@{fields        =
...
$packageHash.add("TAG_Address__c.touchBill", 
@{fields        =
    " 
   max(id)Id
";
...
$packageHash.add("TAG_Address__c.touchShip", 
@{fields        =
    " 
   max(id)Id
";
...
$packageHash.add("TAG_Address__c.migrateStreet", 
@{fields        =
    " 
   Name,Street__c
";
  ...
  # ,Renewal_Mode__c, Account_Seq_Number__c,Account_Name__c,ContractNumber
  $packageHash.add("TAG_Address__c.ckCountry", 
  @{fields        =
      " 
