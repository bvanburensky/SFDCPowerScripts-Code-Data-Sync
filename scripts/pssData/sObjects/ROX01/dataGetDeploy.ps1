...
$targetOrgAlias = 'bvbtest25' 
#$targetOrgAlias = 'bvbtest23'   
...
# perform string replace of the source csv
# can to change source org autonumber field to target's unique or external if for upsert
# see sReplaceFileName for aactual file to use
$replace = $true
...
$onlyProcessFile = ""
$onlyProcessSObject = "Case"
$onlyProcessDirectory = "ROX01"
...
# override the base query to the fields below
